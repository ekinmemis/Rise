...
{
    /// <summary>
    /// Represents Rise engine
    /// </summary>
    public partial class RiseEngine : IEngine
    {
        #region Fields
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var startupConfigurations = _typeFinder.FindClassesOfType<IRiseStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IRiseStartup)Activator.CreateInstance(startup))
        ...
        public void ConfigureRequestPipeline(IApplicationBuilder application)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<IRiseStartup>();
