...
namespace Rise.Core.Infrastructure
{
    ...
    /// </summary>
    public partial class RiseFileProvider : PhysicalFileProvider, IRiseFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a RiseFileProvider
        /// </summary>
        /// <param name="hostingEnvironment">Hosting environment</param>
        public RiseFileProvider(IHostingEnvironment hostingEnvironment)
