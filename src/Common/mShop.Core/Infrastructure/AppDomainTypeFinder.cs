...
namespace Rise.Core.Infrastructure
{
    /// <summary>
    /// A class that finds types needed by Phone by looping assemblies in the 
    ...
    public partial class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IRiseFileProvider _fileProvider;

        #endregion

        #region Ctor

        public AppDomainTypeFinder(IRiseFileProvider fileProvider = null)
        {
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Phone.
        /// </returns>
        ...
        /// <summary>Gets or sets whether Phone should iterate assemblies in the app domain when loading Phone types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Phone assemblies aren't investigated (e.g. by not including something like "^Phone|..." you may break core functionality.</remarks>
